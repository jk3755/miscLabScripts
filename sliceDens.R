...
load("~/atac/h508/TCF7_motif1_genome_signals.RData")

# get the plus and minus signal matrix from the genome signals vector
plus <- TCF7_motif1_genome_signals[["signal"]][["+"]]
minus <- TCF7_motif1_genome_signals[["signal"]][["-"]]
# combine the plus and minus signal
signal <- matrix(data=NA,ncol=212,nrow=4198)
signal[,1:212] <- plus[,1:212] + minus[,1:212]
